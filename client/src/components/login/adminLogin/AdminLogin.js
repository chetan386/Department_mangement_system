...
const AdminLogin = () => {
  ...
  return (
    <div className="bg-[#04bd7d] h-screen w-screen flex flex-col items-center  ">
      <div style={{width:"100%",height:"23%"}}>
       <div className="ml-5 mt-5"><button className="p-2" style={{backgroundColor:"white", borderRadius:"10px"}}><Link to="/">Home</Link></button></div>
       </div>
       <div className="grid grid-cols-2">
        <div
          className={`h-96 w-96 bg-white flex items-center justify-center ${
